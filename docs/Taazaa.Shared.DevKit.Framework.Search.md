...
| public type | description |
| --- | --- |
| class [ComparableSearchCriteria&lt;TMember&gt;](./Taazaa.Shared.DevKit.Framework.Search.TypeSearchExpressions/ComparableSearchCriteria-1.md) | A search expression that combines multiple [`ComparableSearchCriteria`](./Taazaa.Shared.DevKit.Framework.Search.TypeSearchExpressions/ComparableSearchCriteria-1.md)s into a single |
