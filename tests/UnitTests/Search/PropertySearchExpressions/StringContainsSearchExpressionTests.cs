...
[UnitTest(nameof(StringContainsSearchExpression))]
public class StringContainsSearchExpressionTests
{
    [Fact]
    public void GetExpressionShouldReturnTheCorrectExpression()
    {
        const string value = "a";
        StringContainsSearchExpression searchExpression = value;
        ...
        actual!.Method.Should().BeSameAs(typeof(string).GetMethod(nameof(string.Contains), [typeof(string)]));
    }

    [Fact]
    public void ItShouldBeAssignableFromSearchValue()
    {
        Func<StringContainsSearchExpression> func = () =>
        {
            SearchValue<string> searchValue = "b";
            StringContainsSearchExpression expression = searchValue;
    ...
    public void ItShouldBeAssignableFromString()
    {
        Func<StringContainsSearchExpression> func = () =>
        {
            StringContainsSearchExpression expression = "a";
