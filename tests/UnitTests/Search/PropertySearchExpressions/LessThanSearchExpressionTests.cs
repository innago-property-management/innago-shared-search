...
[UnitTest(nameof(LessThanSearchExpression<int>))]
public class LessThanSearchExpressionTests : LessThanSearchExpressionTestsBase<LessThanSearchExpression<int>, int>
{
    [Fact]
    public void GetExpressionShouldReturnCorrectExpression()
    {
        ...
        LessThanSearchExpression<int> searchExpression = searchValue;
